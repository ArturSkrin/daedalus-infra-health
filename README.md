...
Застосунок, код і документи англійською, бо каталог метрик і еталонний екран організаторів теж англійські. Цей файл українською, а слова й дії з екрана наведено так, як вони написані в застосунку.
...
| Слово на екрані | Дія під словом | Рішення з умови завдання |
| --- | --- | --- |
| **ALL CLEAR** | Nothing to do | нічого не робити |
| **SCHEDULE** | Plan the work, not today | запланувати роботу |
| **ACT NOW** | This needs a human today | втрутитись зараз |

Плюс службовий стан **BLIND** з дією «Fix data collection first»: даним не можна вірити, тому жодне з трьох рішень не має підстав.
...
Triage API ───────┘   читає сирий   правила і     слова, підписи,           лише рендер
                      JSON          пороги        drill-in
```
...
| [scenarios.md](scenarios.md) | Одинадцять зрізів із вхідними значеннями, станами, очікуваним рішенням і тим, що виявив прогін |
